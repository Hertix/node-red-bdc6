// nodes/BDC6_DBG_TX.js
module.exports = function(RED) {
  const { toRaw, packBits } = require("../lib/bits.js");
  const SIGNALS = [{"message_name": "BDC6_DBG_TX", "signal_name": "BDC6_DBG_TX", "can_id_hex": "0x439", "start_bit": 0, "bit_length": 64, "factor": "1", "offset": "0", "unit": "", "byte_order": "intel", "signed": 0, "min": "0", "max": "0", "default": "0", "category": "BDC6*", "multiplex": "-", "comment": "Transmitting messages for Param functionality."}];
  function Node(config) {
    RED.nodes.createNode(this, config);
    const node = this;
    const can_id_hex = "0x439";
    const message_name = "BDC6_DBG_TX";
    const map = new Map();
  ...
  RED.nodes.registerType("BDC6_DBG_TX", Node, {
    category: "BDC6*",
    defaults: { name: { value: "BDC6_DBG_TX (CAN 0x439)" } },
    inputs:1, outputs:1, icon:"node-red/message.png", color:"#e8f0ff",
    paletteLabel: "BDC6_DBG_TX",
    label: function(){ return this.name || "BDC6_DBG_TX (CAN 0x439)"; }
  });
}
