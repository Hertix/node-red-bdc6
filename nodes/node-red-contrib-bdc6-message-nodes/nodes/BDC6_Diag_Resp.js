// nodes/BDC6_Diag_Resp.js
module.exports = function(RED) {
  const { toRaw, packBits } = require("../lib/bits.js");
  const SIGNALS = [{"message_name": "BDC6_Diag_Resp", "signal_name": "ISOx_BDC6_Resp_Data", "can_id_hex": "0x1bdaf100", "start_bit": 0, "bit_length": 64, "factor": "1", "offset": "0", "unit": "", "byte_order": "intel", "signed": 0, "min": "0", "max": "0", "default": "0", "category": "BDC6*", "multiplex": "-", "comment": ""}];
  function Node(config) {
    RED.nodes.createNode(this, config);
    const node = this;
    const can_id_hex = "0x1bdaf100";
    const message_name = "BDC6_Diag_Resp";
    const map = new Map();
  ...
  RED.nodes.registerType("BDC6_Diag_Resp", Node, {
    category: "BDC6*",
    defaults: { name: { value: "BDC6_Diag_Resp (CAN 0x1bdaf100)" } },
    inputs:1, outputs:1, icon:"node-red/message.png", color:"#e8f0ff",
    paletteLabel: "BDC6_Diag_Resp",
    label: function(){ return this.name || "BDC6_Diag_Resp (CAN 0x1bdaf100)"; }
  });
}
